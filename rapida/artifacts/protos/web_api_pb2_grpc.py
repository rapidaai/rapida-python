...
import rapida.artifacts.protos.web_api_pb2 as web__api__pb2
...
class LeadServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateLead = channel.unary_unary(
                '/web_api.LeadService/CreateLead',
                request_serializer=web__api__pb2.LeadCreationRequest.SerializeToString,
                response_deserializer=common__pb2.BaseResponse.FromString,
                _registered_method=True)
...
def add_LeadServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateLead': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateLead,
                    request_deserializer=web__api__pb2.LeadCreationRequest.FromString,
                    response_serializer=common__pb2.BaseResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'web_api.LeadService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('web_api.LeadService', rpc_method_handlers)
...
class LeadService(object):
    ...
    def CreateLead(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/web_api.LeadService/CreateLead',
            web__api__pb2.LeadCreationRequest.SerializeToString,
            common__pb2.BaseResponse.FromString,
            options,
            channel_credentials,
            insecure,
