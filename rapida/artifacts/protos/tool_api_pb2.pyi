...
class ToolProvider(_message.Message):
    __slots__ = ("id", "name", "description", "image", "status")
    ...
    image: str
    status: str
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., image: _Optional[str] = ..., status: _Optional[str] = ...) -> None: ...

class Tool(_message.Message):
    __slots__ = ("id", "toolProvider", "feature", "name", "actor", "status", "connectConfiguration")
    ...
    ID_FIELD_NUMBER: _ClassVar[int]
    TOOLPROVIDER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[int] = ..., toolProvider: _Optional[_Union[ToolProvider, _Mapping]] = ..., feature: _Optional[str] = ..., name: _Optional[str] = ..., actor: _Optional[str] = ..., status: _Optional[str] = ..., connectConfiguration: _Optional[_Mapping[str, str]] = ...) -> None: ...
