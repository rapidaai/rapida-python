...
class EndpointProviderModel(_message.Message):
    __slots__ = ("id", "modelType", "modelModeType", "chatCompletePrompt", "completePrompt", "textToImagePrompt", "textToSpeechPrompt", "speechToTextPrompt", "providerModelId", "providerModel", "endpointProviderModelParameters", "status", "createdBy", "createdUser", "updatedBy", "updatedUser", "createdDate", "updatedDate", "endpointId", "description")
    ...
    COMPLETEPROMPT_FIELD_NUMBER: _ClassVar[int]
    TEXTTOIMAGEPROMPT_FIELD_NUMBER: _ClassVar[int]
    TEXTTOSPEECHPROMPT_FIELD_NUMBER: _ClassVar[int]
    SPEECHTOTEXTPROMPT_FIELD_NUMBER: _ClassVar[int]
    PROVIDERMODELID_FIELD_NUMBER: _ClassVar[int]
    PROVIDERMODEL_FIELD_NUMBER: _ClassVar[int]
    ENDPOINTPROVIDERMODELPARAMETERS_FIELD_NUMBER: _ClassVar[int]
    ...
    completePrompt: _common_pb2.TextCompletePrompt
    textToImagePrompt: _common_pb2.TextToImagePrompt
    textToSpeechPrompt: _common_pb2.TextToSpeechPrompt
    speechToTextPrompt: _common_pb2.SpeechToTextPrompt
    providerModelId: int
    providerModel: _common_pb2.ProviderModel
    endpointProviderModelParameters: _containers.RepeatedCompositeFieldContainer[_common_pb2.ProviderModelParameter]
    status: str
    createdBy: int
...
class Endpoint(_message.Message):
    __slots__ = ("id", "status", "visibility", "source", "sourceIdentifier", "type", "projectId", "organizationId", "endpointProviderModelId", "endpointProviderModel", "endpointAnalytics", "endpointRetry", "endpointCaching", "endpointTag", "language", "organization", "name", "description", "createdDate", "updatedDate", "createdBy", "createdUser", "updatedBy", "updatedUser")
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
...
class EndpointAttribute(_message.Message):
    ...
    name: str
    description: str
    def __init__(self, source: _Optional[str] = ..., sourceIdentifier: _Optional[int] = ..., type: _Optional[str] = ..., visibility: _Optional[str] = ..., language: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ...) -> None: ...
...
class SearchableDeployment(_message.Message):
    __slots__ = ("id", "status", "visibility", "type", "projectId", "organizationId", "tag", "language", "organization", "name", "description", "createdDate", "updatedDate", "providerModelId", "providerId", "appAppearance", "webAppearance")
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    VISIBILITY_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
